...
export default function ProfileAvatarModal({ isDark, isArabic, showAvatarPicker, setShowAvatarPicker, isUploadingAvatar, activeUser, avatarOptions, updateChildProfile, handleImageUpload }) {
    return (
