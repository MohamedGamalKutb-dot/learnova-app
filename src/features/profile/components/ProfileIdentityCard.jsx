...
export default function ProfileIdentityCard({ isDark, isArabic, userRole, activeUser, editingField, editValue, setEditValue, setEditingField, startEdit, saveEdit }) {
    const fields = [
