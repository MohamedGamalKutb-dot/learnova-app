...
interface PecsItemsGridProps {
    isDark: boolean;
    isArabic: boolean;
    items: any[];
    selectedCategory: string;
    addToSentence: (item: any) => void;
}

export default function PecsItemsGrid({ isDark, isArabic, items, selectedCategory, addToSentence }: PecsItemsGridProps) {
