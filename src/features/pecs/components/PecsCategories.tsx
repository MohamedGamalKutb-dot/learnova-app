...
export default function PecsCategories({ isDark, isArabic, categories, selectedCategory, setSelectedCategory, categoryIcons, categoryLabels, categoryLabelsAr }: PecsCategoriesProps) {
    return (
