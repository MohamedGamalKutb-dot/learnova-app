...
interface ClinicalOverviewTabProps {
    ...
    setViewingAssessment: (assessment: any) => void;
    hero: any;
    behaviorTypes: any[];
}
            ...
            <CardBody className="p-5 sm:p-10">
                    ...
                    <div className="space-y-4 animate-in fade-in duration-500">
                        {viewingAssessment ? (
                            ...
                            <div className="space-y-3">
                                ...
                                ) : ([...(hero?.assessments || [])].reverse().map((ass: any, idx: number) => (
                ...
                {activeReportTab === 'behavior' && (
                    <div className="space-y-4 animate-in fade-in duration-500">
                        ...
                        ) : (Array.isArray(hero?.behaviorLogs) ? [...hero.behaviorLogs].reverse().map((log: any, idx: number) => {
