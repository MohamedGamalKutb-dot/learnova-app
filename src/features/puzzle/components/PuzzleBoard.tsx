...
interface PuzzleBoardProps {
    ...
    handleDrop: (e: any, slotIndex: number) => void;
    handleSlotTap: (slotIndex: number) => void;
}

export default function PuzzleBoard({ TOTAL_PIECES, COLS, ROWS, placedPieces, draggedPiece, isDark, isArabic, imageLoaded, currentImage, handleDragOver, handleDrop, handleSlotTap }: PuzzleBoardProps) {
    return (
        <motion.div
