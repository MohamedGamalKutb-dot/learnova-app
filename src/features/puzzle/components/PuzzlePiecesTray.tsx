...
interface PuzzlePiecesTrayProps {
    pieces: number[];
    COLS: number;
    ROWS: number;
    ...
    setDraggedPiece: (index: number | null) => void;
}

export default function PuzzlePiecesTray({ pieces, COLS, ROWS, draggedPiece, isDark, isArabic, imageLoaded, currentImage, handleDragStart, setDraggedPiece }: PuzzlePiecesTrayProps) {
    return (
        <motion.div
