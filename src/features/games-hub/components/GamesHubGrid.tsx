...
interface GamesHubGridProps {
    isDark: boolean;
    isArabic: boolean;
    games: any[];
    labels: Record<string, { ar: string; en: string }>;
    descriptions: Record<string, { ar: string; en: string }>;
}

export default function GamesHubGrid({ isDark, isArabic, games, labels, descriptions }: GamesHubGridProps) {
