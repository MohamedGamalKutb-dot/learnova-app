...
interface WordGameSlotsProps {
    ...
    handleLetterSelect: (index: number) => void;
}

export default function WordGameSlots({ isDark, isArabic, currentWord, answer, showResult, isCorrect, resultMessage, shuffledLetters, selectedIndices, handleRemoveLetter, handleLetterSelect }: WordGameSlotsProps) {
    return (
        <motion.div
