...
export default function PianoMelodiesModal({ isMelodiesOpen, onMelodiesClose, isDark, isArabic, savedMelodies, handleDeleteMelody, handlePlaySavedMelody, isPlaying }) {
    return (
