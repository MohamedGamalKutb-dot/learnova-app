...
export default function PianoCurrentNote({ isDark, isArabic, lastNote, KEY_COLORS }) {
    return (
        <motion.div
        ...
        >
            <AnimatePresence mode="wait">
                ...
                >
                    <span className="text-4xl sm:text-5xl font-black" style={{ color: KEY_COLORS[lastNote] || (isDark ? '#e2e8f0' : '#1e293b') }}>
                        {lastNote || '🎵'}
                    </span>
                    {lastNote && (
