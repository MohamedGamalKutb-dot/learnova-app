...
export default function PianoControls({ isDark, isArabic, isRecording, recording, isPlaying, handleStartRecording, handleStopRecording, handlePlayRecording, handleSaveMelody, onMelodiesOpen, savedMelodiesCount }) {
    return (
        <motion.div
