...
interface ArtStudioGalleryModalProps {
    isGalleryOpen: boolean;
    onGalleryClose: () => void;
    isDark: boolean;
    isArabic: boolean;
    savedDrawings: any[];
    handleLoadDrawing: (data: string) => void;
    handleDeleteDrawing: (id: string) => void;
}

export default function ArtStudioGalleryModal({ isGalleryOpen, onGalleryClose, isDark, isArabic, savedDrawings, handleLoadDrawing, handleDeleteDrawing }: ArtStudioGalleryModalProps) {
    return (
