...
interface ArtStudioCanvasProps {
    isDark: boolean;
    isArabic: boolean;
    SHAPES: Record<string, { isCircle?: boolean; isOval?: boolean; path?: string }>;
    canvasShapes: any[];
    selectedShapeId: string | null;
    canvasRef: React.RefObject<HTMLCanvasElement | null>;
    startDraw: (e: any) => void;
    draw: (e: any) => void;
    endDraw: () => void;
    setCanvasShapes: (updater: (prev: any[]) => any[]) => void;
    setSelectedShapeId: (id: string | null) => void;
}

export default function ArtStudioCanvas({ isDark, isArabic, SHAPES, canvasShapes, selectedShapeId, canvasRef, startDraw, draw, endDraw, setCanvasShapes, setSelectedShapeId }: ArtStudioCanvasProps) {
    return (
        <div 
