...
export default function ArtStudioRightPanel({ isDark, COLORS, BRUSH_SIZES, activeColor, setActiveColor, setActiveTool, brushSize, setBrushSize, showColorPicker, setShowColorPicker, customColor, setCustomColor }) {
    return (
        <motion.div
