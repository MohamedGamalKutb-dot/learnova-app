    ...
    return (
        <div className={`min-h-screen flex font-[Inter,'Segoe_UI',sans-serif] ${isDark ? 'bg-bg-dark' : 'bg-bg'}`}>
            ...
            <div className="flex-1 hidden md:flex flex-col items-center justify-center bg-gradient-to-br from-accent to-[#8B5CF6] to-[#FF6584] p-10 relative overflow-hidden min-h-screen">
                <div className="absolute top-[10%] left-[10%] w-20 h-20 opacity-15 overflow-hidden" style={{ animation: 'float 6s ease-in-out infinite' }}><img src="/icons/games.png" className="w-full h-full object-cover"  loading="lazy" decoding="async" alt=""/></div>
                ...
                <div className="absolute bottom-[30%] right-[10%] w-16 h-16 opacity-[0.12] overflow-hidden" style={{ animation: 'float 5s ease-in-out infinite 0.5s' }}><img src="/icons/emotion_emo_happy.png" className="w-full h-full object-cover"  loading="lazy" decoding="async" alt=""/></div>
                <div className="w-32 h-32 mb-5 z-[1] overflow-hidden rounded-3xl shadow-2xl"><img src="/icons/games.png" className="w-full h-full object-cover"  loading="lazy" decoding="async" alt=""/></div>
            ...
            <div className="flex-1 flex items-center justify-center py-10 px-6 min-h-screen">
                <div className="max-w-[420px] w-full">
                    ...
                    <h1 className={`text-[28px] font-extrabold mb-1.5 ${isDark ? 'text-text-dark' : 'text-text'} flex items-center gap-3`}>
                        <div className="w-10 h-10 overflow-hidden rounded-xl"><img src="/icons/games.png" className="w-full h-full object-cover"  loading="lazy" decoding="async" alt=""/></div> {isArabic ? 'تسجيل دخول الطفل' : 'Child Login'}
                    </h1>
                    ...
                    <div className="mt-5">
                        <Button fullWidth variant="bordered" radius="lg"
                            ...
                            startContent={<div className="w-5 h-5 overflow-hidden rounded-md"><img src="/icons/rewards.png" className="w-full h-full object-contain"  loading="lazy" decoding="async" alt=""/></div>}>
